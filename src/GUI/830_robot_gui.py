...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        loadUi('robot_gui.ui', self)  # Load UI file
        ...
        self.ros_thread.position_signal.connect(self.update_position_and_marker)  # Connect position signal
    ...
    def toggle_bringup(self):
        if self.bringup_process is not None:
            ...
            print("bringup.launch.py process start.")
    ...
    def update_velocity(self, value):
        self.current_cmd.linear.x = value / 100.0
        self.publish_cmd_vel()

    def update_angular(self, value):
        self.current_cmd.angular.z = value / 100.0
        self.publish_cmd_vel()
